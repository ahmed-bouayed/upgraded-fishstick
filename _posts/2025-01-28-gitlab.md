...
edit the file of configuration
```shell
...
Edit the GitLab configuration file (/etc/gitlab/gitlab.rb) and add the following SMTP settings:

gitlab_rails['smtp_enable'] = true
gitlab_rails['smtp_address'] = "smtp.gmail.com"
gitlab_rails['smtp_port'] = 587
gitlab_rails['smtp_user_name'] = "your_email@gmail.com"
gitlab_rails['smtp_password'] = "your_app_password"  # Use App Password if 2FA is enabled
...
Update GitLab Configuration:
Edit the GitLab configuration file (/etc/gitlab/gitlab.rb) and add the following IMAP settings:

gitlab_rails['incoming_email_enabled'] = true
gitlab_rails['incoming_email_address'] = "incoming+%{key}@gmail.com"
gitlab_rails['incoming_email_host'] = "imap.gmail.com"
gitlab_rails['incoming_email_port'] = 993
gitlab_rails['incoming_email_ssl'] = true
gitlab_rails['incoming_email_user'] = "your_email@gmail.com"
gitlab_rails['incoming_email_password'] = "your_app_password"  # Use App Password if 2FA is enabled
...
Create an issue or merge request in GitLab.

Reply to the notification email using the email address provided by GitLab.

Verify that the reply is added to the issue or merge request.
